          ...
          <div className="w-3/4 flex flex-col">
            {selectedCustomer?.id ? (
              <>
                ...
                <form onSubmit={handleSendMessage} className={`p-4 border-t border-gray-200 dark:border-gray-800 flex relative transition-colors duration-200 ${isPrivateChat
                  ...
                  <div className="flex items-center mr-2">
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isPrivateChat ? 'bg-gray-600' : 'bg-gray-300 dark:bg-gray-600'
                        }`}>
                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${isPrivateChat ? 'translate-x-6' : 'translate-x-1'
                          }`} />
                      </div>
                  ...
                  <input
                    ...
                    className={`flex-1 p-2 border rounded-l-lg focus:outline-none focus:ring-0 custom-caret transition-colors duration-200 ${isPrivateChat
